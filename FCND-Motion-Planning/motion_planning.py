...
class MotionPlanning(Drone):
    ...
    def plan_path(self):
        ...
        #_______________________________________STUDENT_CODE_BEGIN_____________________________________________#
        #------------------------------------------------------------------------------------------------------#
        ...
        with open('colliders.csv' , 'r') as csv_file:
            ...
            lat0 = float((x[0].strip('lat0')))
            lon0 = float((x[1].strip(' lon0')))
        ...
        print("north_start:",north_start,"east_start",east_start)
